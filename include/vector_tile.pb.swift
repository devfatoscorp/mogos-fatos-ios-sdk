...
struct VectorTile_Tile: SwiftProtobuf.ExtensibleMessage {
  ...
  struct Layer: SwiftProtobuf.ExtensibleMessage {
    ...
    /// Returns true if `tz` has been explicitly set.
    var hasTz: Bool {return self._tz != nil}
    /// Clears the value of `tz`. Subsequent reads from it will return its default value.
    mutating func clearTz() {self._tz = nil}
    ...
    var hasTy: Bool {return self._ty != nil}
    ...
    fileprivate var _tz: UInt32? = nil
    fileprivate var _tx: UInt32? = nil
    fileprivate var _ty: UInt32? = nil
    fileprivate var _id: UInt64? = nil
...
extension VectorTile_Tile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self._extent) }()
...
extension VectorTile_Tile.Layer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 11: try { try decoder.decodeSingularUInt64Field(value: &self._id) }()
      case 12: try { try decoder.decodeSingularUInt32Field(value: &self._ty) }()
      case 13: try { try decoder.decodeSingularUInt32Field(value: &self._tx) }()
      case 14: try { try decoder.decodeSingularUInt32Field(value: &self._tz) }()
  ...
  static func ==(lhs: VectorTile_Tile.Layer, rhs: VectorTile_Tile.Layer) -> Bool {
    ...
    if lhs._tz != rhs._tz {return false}
