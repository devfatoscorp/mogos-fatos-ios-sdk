...
#ifndef MOGOSKIT_SWIFT_H
#define MOGOSKIT_SWIFT_H
...
@interface FatosInterface : NSObject <FatosMapViewDelegate, FatosNaviModuleDelegate, GPSServiceDelegate>
...
- (void)PosWorldLocationUpdateListener:(NSString * _Nonnull)strLocation;
- (void)TouchMoveModeListener:(int32_t)nMode;
- (void)MapLongTouchListener:(int32_t)x y:(int32_t)y;
- (void)UpdatePickerInfo:(NSString * _Nonnull)strID nLong:(int32_t)nLong nLat:(int32_t)nLat;
- (void)UpdateMapAngle:(float)fAngle;
- (void)UpdateViewMode:(int32_t)nViewMode;
...
@interface VoiceManager (SWIFT_EXTENSION(MogosKit)) <CXCallObserverDelegate>
...
@interface VoiceManager (SWIFT_EXTENSION(MogosKit)) <AVSpeechSynthesizerDelegate>
...
SWIFT_CLASS("_TtC8MogosKit13config_result")
@interface config_result : NSObject
...
SWIFT_CLASS("_TtC8MogosKit9rg_result")
@interface rg_result : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8MogosKit12route_result")
@interface route_result : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8MogosKit13search_result")
